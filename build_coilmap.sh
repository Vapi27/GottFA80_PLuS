...
if [ $RC -eq 0 ]; then
  ...
  quartus_cpf -c -d EPCS16 -s 10CL006YE144C8G output_files/SYS80.sof output_files/SYS80_10cl006_coilmap.jic
  echo "=== CPF RC=$? ==="
  md5sum output_files/SYS80_10cl006_coilmap.jic 2>/dev/null
fi
echo "=== ALL DONE $(date) ==="
