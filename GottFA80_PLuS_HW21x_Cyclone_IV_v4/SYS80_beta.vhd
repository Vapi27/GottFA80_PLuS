...
-- V2.00 -- 11.05.2023 adapted to Cyclone IV  and late 80B games 
-- V3.00 -- 16.03.2024 adapted to Cyclone IV  EP4CE6E22C8N

-- v xxx HW v2.x with integrated soundboard
...
port map(
   ...
   show  => not game_running,
	...
	-- input (display data)		
	display1	=> "    310",  -- SW VERSION TO BE PUT HERE
