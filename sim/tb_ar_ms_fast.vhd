--------------------------------------------------------------------------
-- tb_ar_ms_fast : AR_MS = 50000 vaut-il bien 1 ms a 50 MHz ?
...
entity tb_ar_ms_fast is
end tb_ar_ms_fast;

architecture sim of tb_ar_ms_fast is
...
begin
  ...
  begin
    write(L, string'("==== tb_ar_ms_fast : AR_MS = 50000, clk_50 = 20 ns ====")); writeline(output, L);
    ...
    mesure(fire_10ms, "10*AR_MS   (10 ms vise)", (10*AR_MS + 1) * TCLK50, 3);
